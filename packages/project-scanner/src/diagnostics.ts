...
export const DiagnosticCode = {
  ...
  WORKSPACE_DUPLICATE_MATCH: "WORKSPACE_DUPLICATE_MATCH",
  WORKSPACE_DUPLICATE_NAME: "WORKSPACE_DUPLICATE_NAME",
  WORKSPACE_DUPLICATE_DIRECTORY: "WORKSPACE_DUPLICATE_DIRECTORY",
  WORKSPACE_DEPENDENCY_UNRESOLVED: "WORKSPACE_DEPENDENCY_UNRESOLVED",
  WORKSPACE_MANIFEST_OUTSIDE_DECLARATION: "WORKSPACE_MANIFEST_OUTSIDE_DECLARATION",
